# 🚀 Portfólio Pessoal - Vanessa Macêdo
...
- ✅ Interatividade com JavaScript (array de objetos)
- ✅ Versionamento no GitHub
- ✅ Publicação via GitHub Pages

## 👩‍💻 Sobre Mim

Estudante de **Tecnologia em Sistemas para Internet** na UESPI, apaixonada por desenvolvimento web e sempre em busca de novos aprendizados.

- 🎓 **Instituição**: UESPI - Universidade Estadual do Piauí
- 💻 **Curso**: Tecnologia em Sistemas para Internet
- 🌟 **Interesses**: Front-end, UX/UI, boas práticas de desenvolvimento
